  ...
  return (
    <section className="columns is-mobile">
      <div className="column is-flex is-flex-direction-column">
        <h2 className="has-text-centered my-3 is-size-3">About Me</h2>
        <img className="is-align-self-center m-3" src={profilePhoto} alt="Daniel Kim profile photo" width="200px" style={{ border: "3px solid #C0C5C1" }} />
        <p className="column is-three-fifths is-offset-one-fifth" style={{ backgroundColor: "#AF9164", color: "#F2F7F2" }}>
