  ...
  return (
    <section className="columns is-mobile">
      <div className="column is-flex is-flex-direction-column">
        ...
        <img id="profile-img" className="is-align-self-center m-3" src={profilePhoto} alt="DK profile pic" width="200px" style={{ border: "5px solid #50808E" }} />
        <p className="column is-three-fifths is-offset-one-fifth is-size-5 mt-6" style={{ backgroundColor: "#AF9164", color: "#F2F7F2" }}>
